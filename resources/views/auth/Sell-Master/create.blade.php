...
<input type="button" value="Add New" id="add" class="add-row btn btn-primary" />
&nbsp;
...
<script type="text/javascript">
  ...
  {
  var markup = '<tr><td><input name="item_name[]" class="Product" placeholder="Iteam Name" type="text" ></td><td><input name="quantity[]" class="Quantity" placeholder="Quantity" type="text" ></td><td><input name="price[]" class="Rate" placeholder="Rate" type="text" ></td><td><input name="total_price[]" class="Amount" placeholder="Tatal Price" type="text" ></td><td><input type="button" value="&times;" class="del btn btn-danger" /></td></tr>';
   $(".maxvalue").val(max);
    max++;
